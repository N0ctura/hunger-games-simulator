...
export interface GameConfig {
  ...
  deathRate?: number;
  cornucopiaLethality?: number; // 0-1, controlla aggressivamente la % di morti nella Cornucopia
...
export const DEFAULT_CORNUCOPIA_EVENTS: GameEvent[] = [
  ...
  { id: "c36", text: "{P1} si arrampica sulla Cornucopia e spara frecce dall'alto.", type: "arena", isFatal: false, killCount: 0, weight: 5 },
  { id: "c37", text: "{P1} e {P2} si contendono una sacca di viveri, ma la rompono.", type: "arena", isFatal: false, killCount: 0, weight: 4 },
  { id: "c38", text: "{P1} trova una fiala di veleno ma la perde nella corsa.", type: "arena", isFatal: false, killCount: 0, weight: 4 },
  { id: "c39", text: "{P1} viene spinto a terra da {P2} ma riesce a rialzarsi e scappare.", type: "arena", isFatal: false, killCount: 0, weight: 5 },
  { id: "c40", text: "{P1} lancia un coltello contro {P2} ma lo manca clamorosamente.", type: "arena", isFatal: false, killCount: 0, weight: 5 },
  { "id": "a1", "text": "Un improvviso incendio boschivo costringe {P1} a fuggire.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a2", "text": "Una fitta nebbia avvolge l'arena, isolando {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a3", "text": "Uno sciame di vespe insegue {P1} e {P2}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a4", "text": "La temperatura scende drasticamente; {P1} trema violentemente.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a5", "text": "Un terremoto scuote il terreno, facendo cadere {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a6", "text": "Pioggia torrenziale allaga l'area dove si trova {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a7", "text": "{P1} trova un piccolo cumulo di rifornimenti lanciato dagli Strateghi.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a8", "text": "Delle scimmie mutanti osservano {P1} dagli alberi.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a9", "text": "L'aria diventa irrespirabile, obbligando {P1} a spostarsi.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a10", "text": "Un fulmine colpisce un albero vicino a {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a11", "text": "{P1} viene schiacciato da un albero abbattuto dal vento.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a12", "text": "Una nebbia acida scioglie la pelle di {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a13", "text": "{P1} annega in un'improvvisa inondazione lampo.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a14", "text": "Branco di lupi mutanti sbrana {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a15", "text": "Una scarica elettrica dal cielo colpisce in pieno {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a16", "text": "{P1} viene inghiottito dalle sabbie mobili.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a17", "text": "Uccelli mutanti colpiscono ripetutamente {P1} fino alla morte.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a18", "text": "Un'esplosione sotterranea investe {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a19", "text": "{P1} muore per le ustioni causate da una pioggia di fuoco.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a20", "text": "Un gas soporifero letale ferma il cuore di {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a21", "text": "{P1} trova una grotta per ripararsi dalla grandine.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a22", "text": "{P1} usa una foglia gigante come ombrello.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a23", "text": "Il terreno sotto {P1} cede, ma riesce a risalire.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a24", "text": "Una brezza fresca ridona energia a {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a25", "text": "{P1} si ferisce con delle spine mentre scappa da un mutante.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a26", "text": "Il rumore di un cannone spaventa {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a27", "text": "{P1} vede un altro tributo morire in lontananza.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a28", "text": "{P1} beve l'acqua piovana raccolta.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a29", "text": "Il fumo di un incendio lontano irrita gli occhi di {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a30", "text": "{P1} perde l'orientamento a causa del fumo.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a31", "text": "Un branco di orsi mutanti attacca {P1} e {P2}. Entrambi muoiono.", "type": "arena", "isFatal": true, "killCount": 2, "killer": null, "victims": [1, 2], "weight": 3 },
  { "id": "a32", "text": "Una valanga travolge {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a33", "text": "{P1} viene punto da un insetto geneticamente modificato e muore.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a34", "text": "Il ghiaccio sottile si rompe e {P1} annega nel lago gelato.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a35", "text": "Una trappola degli Strateghi decapita {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a36", "text": "{P1} viene mangiato vivo da formiche giganti.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a37", "text": "Un'improvvisa ondata di calore estremo uccide {P1} per disidratazione.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a38", "text": "Un masso cade sulla testa di {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a39", "text": "Delle liane velenose strangolano {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a40", "text": "Gli Strateghi fanno esplodere la zona dove si trova {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a41", "text": "{P1} scivola nel fango ma non si fa nulla.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a42", "text": "{P1} sente urla agghiaccianti ma è al sicuro.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a43", "text": "{P1} guarda un paracadute atterrare lontano.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a44", "text": "{P1} mangia un frutto caduto durante una tempesta.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a45", "text": "{P1} si rifugia sotto una sporgenza rocciosa.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a46", "text": "L'odore di zolfo spaventa {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a47", "text": "{P1} viene quasi colpito da una freccia vagante.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a48", "text": "Un vento forte spazza via lo zaino di {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a49", "text": "{P1} trova una zona con acqua pulita dopo il terremoto.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a50", "text": "{P1} si nasconde dai droni delle telecamere.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a51", "text": "Un'improvvisa pioggia di petali velenosi irrita la pelle di {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a52", "text": "Le telecamere degli Strateghi ronzano vicino a {P1}, rivelando la sua posizione.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a53", "text": "{P1} viene quasi travolto da una frana di sassi.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a54", "text": "Un forte vento trasporta l'odore di cibo, torturando {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a55", "text": "{P1} trova una pozza di fango termale che lenisce le sue ferite.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a56", "text": "L'erba alta intorno a {P1} prende fuoco spontaneamente.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a57", "text": "Uno sciame di farfalle carnivore morde leggermente {P1} prima di volare via.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a58", "text": "{P1} deve arrampicarsi su una roccia per sfuggire a un'inondazione improvvisa.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a59", "text": "Un forte boato scuote l'arena, facendo perdere l'equilibrio a {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a60", "text": "{P1} vede il riflesso di un laser sulla sua spalla e si tuffa al riparo.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },

  { "id": "a61", "text": "Una nube di gas nervino uccide istantaneamente {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a62", "text": "Piante rampicanti trascinano {P1} nel sottosuolo. Non riemerge più.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a63", "text": "{P1} viene sbranato da un ibrido tra un leone e una vespa.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a64", "text": "Un fulmine globulare insegue e incenerisce {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a65", "text": "La terra si apre sotto {P1}, che precipita in un abisso senza fondo.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a66", "text": "{P1} muore dopo aver bevuto da una sorgente che gli Strateghi hanno avvelenato.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a67", "text": "Una grandinata di proiettili di ghiaccio trafigge {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a68", "text": "Uno sciame di api mutanti inietta un veleno letale a {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a69", "text": "{P1} calpesta una mina dimenticata dagli Strateghi e salta in aria.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a70", "text": "{P1} viene colpito da un detrito volante durante un tornado.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },

  { "id": "a71", "text": "{P1} trova una lancia conficcata in un tronco d'albero.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a72", "text": "Un drone consegna un messaggio a {P1} ma non contiene nulla.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a73", "text": "{P1} sente il rumore di passi giganti ma è solo un'illusione sonora.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a74", "text": "Il cielo diventa improvvisamente rosso sangue, inquietando {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a75", "text": "{P1} si ripara dalla pioggia sotto la carcassa di un animale.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a76", "text": "Una scossa elettrica dal suolo fa sobbalzare {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a77", "text": "{P1} raccoglie delle bacche che gli danno una strana euforia.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a78", "text": "{P1} riesce a evitare una trappola a pressione.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a79", "text": "L'acqua del fiume diventa viola, {P1} decide di non berla.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a80", "text": "Un forte vento gelido strappa la giacca di {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },

  { "id": "a81", "text": "{P1} viene decapitato da un filo invisibile teso tra due alberi.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a82", "text": "Un'ondata di caldo estremo fa bollire l'acqua nel corpo di {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a83", "text": "{P1} viene mangiato vivo da un banco di pesci mutanti mentre attraversa il fiume.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a84", "text": "Un masso lanciato da un vulcano in eruzione colpisce {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a85", "text": "Delle scimmie mutanti strappano gli arti a {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a86", "text": "{P1} muore per un'infezione rapida causata da un graffio mutante.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a87", "text": "Un muro di fiamme circonda {P1} e lo brucia vivo.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a88", "text": "Un'improvvisa mancanza d'ossigeno in una zona dell'arena soffoca {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a89", "text": "{P1} cade in un nido di serpenti corallo giganti.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a90", "text": "Il cannone spara per {P1}, colpito da un raggio laser orbitale.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },

  { "id": "a91", "text": "{P1} trova un binocolo rotto.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a92", "text": "{P1} viene spaventato dal verso di un uccello imitatore.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a93", "text": "{P1} si lava le ferite in un ruscello ghiacciato.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a94", "text": "Un albero cade vicino a {P1}, ma non lo colpisce.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a95", "text": "{P1} scava una buca per ripararsi dal vento.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a96", "text": "Un drone degli sponsor vola sopra {P1} senza lasciar cadere nulla.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a97", "text": "{P1} mangia della neve per idratarsi.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a98", "text": "{P1} osserva una battaglia tra due mutanti in lontananza.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a99", "text": "Una nebbia leggera impedisce a {P1} di vedere oltre i suoi piedi.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a100", "text": "{P1} trova un accendino scarico.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },

  { "id": "a101", "text": "Un'esplosione di mine uccide {P1} e {P2}.", "type": "arena", "isFatal": true, "killCount": 2, "killer": null, "victims": [1, 2], "weight": 3 },
  { "id": "a102", "text": "{P1} viene trafitto da un ramo appuntito durante una tempesta.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a103", "text": "Il fumo tossico riempie i polmoni di {P1}, uccidendolo.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a104", "text": "{P1} muore assiderato durante una notte creata artificialmente.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a105", "text": "Un predatore invisibile squarta {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a106", "text": "{P1} scivola da un dirupo mentre scappa da un mutante.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a107", "text": "Un fulmine colpisce l'acqua in cui {P1} stava nuotando.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a108", "text": "{P1} viene schiacciato dal crollo di una grotta.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a109", "text": "{P1} muore mangiando un frutto esplosivo.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a110", "text": "Una pioggia acida scioglie l'attrezzatura e la pelle di {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },

  { "id": "a111", "text": "{P1} sente l'inno di Panem suonare nelle orecchie.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a112", "text": "{P1} trova una vecchia coperta sporca di sangue.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a113", "text": "Un corvo mutante ruba un pezzo di cibo a {P1}.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a114", "text": "{P1} si nasconde in un tronco cavo.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a115", "text": "{P1} usa del fango per coprire una ferita che scotta.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a116", "text": "Un terremoto di lieve intensità fa cadere {P1} dall'albero.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a117", "text": "{P1} trova degli stivali della sua taglia.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a118", "text": "{P1} osserva un aereo di pattuglia passare sopra l'arena.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a119", "text": "{P1} beve l'umidità dalle foglie.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },
  { "id": "a120", "text": "{P1} inciampa su uno scheletro di un tributo degli anni passati.", "type": "arena", "isFatal": false, "killCount": 0, "weight": 5 },

  { "id": "a121", "text": "{P1} viene travolto da una colata di fango bollente.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a122", "text": "Una tempesta di sabbia abrasiva consuma i polmoni di {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a123", "text": "Un branco di cani mutanti circonda e uccide {P1}.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a124", "text": "{P1} viene colpito da un dardo sparato da una trappola automatica.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a125", "text": "L'arena si restringe e {P1} finisce fuori dai confini, morendo all'istante.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a126", "text": "Un'ondata anomala trascina {P1} al largo del lago.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a127", "text": "{P1} viene punto da una medusa mutante volante.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a128", "text": "Un paracadute esplosivo inganna {P1}, uccidendolo all'apertura.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a129", "text": "{P1} muore per un attacco cardiaco indotto da onde sonore degli Strateghi.", "type": "arena", "isFatal": true, "killCount": 1, "killer": null, "victims": [1], "weight": 5 },
  { "id": "a130", "text": "{P1} e {P2} vengono schiacciati dal collasso della Cornucopia.", "type": "arena", "isFatal": true, "killCount": 2, "killer": null, "victims": [1, 2], "weight": 3 }
]