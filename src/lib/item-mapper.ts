...
export interface ItemMapping {
  ...
  name?: string;
  cdnUrl?: string;
  source?: WovAvatarItem['source'];
  tags?: string[];
}

// Map short IDs or specific IDs to their metadata
export const DEFAULT_SKINS: WovAvatarItem[] = [
  { id: "skin_pale", type: "SKIN", rarity: "COMMON", name: "Pale", imageUrl: "color:#F5D0B0", tags: ["Skin", "White"] },
  { id: "skin_tan", type: "SKIN", rarity: "COMMON", name: "Tan", imageUrl: "color:#E0AC69", tags: ["Skin", "Orange"] },
  { id: "skin_brown", type: "SKIN", rarity: "COMMON", name: "Brown", imageUrl: "color:#8D5524", tags: ["Skin", "Brown"] },
  { id: "skin_dark_brown", type: "SKIN", rarity: "COMMON", name: "Dark Brown", imageUrl: "color:#523218", tags: ["Skin", "Brown"] },
  { id: "skin_black", type: "SKIN", rarity: "COMMON", name: "Black", imageUrl: "color:#2B2B2B", tags: ["Skin", "Black"] },
  { id: "skin_grey", type: "SKIN", rarity: "COMMON", name: "Grey", imageUrl: "color:#7A7A7A", tags: ["Skin", "Grey"] },
  { id: "skin_werewolf", type: "SKIN", rarity: "COMMON", name: "Werewolf", imageUrl: "color:#607D8B", tags: ["Skin", "Blue", "Grey"] },
  { id: "skin_white", type: "SKIN", rarity: "COMMON", name: "White", imageUrl: "color:#FFFFFF", tags: ["Skin", "White"] },
];
